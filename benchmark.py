...
def main(args):
    ...
    print('------ Result ------')
    print('behavior: {} | mode: {} | epoch: {}'.format(
        args.behavior, args.mode, args.epoch), sep='\t')
